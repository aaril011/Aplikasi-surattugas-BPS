...
Public Class LpSuratTugas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AplikasiSuratTugasBPS.LpSuratTugas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLpSuratTugas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LpSuratTugas = New LpSuratTugas()
        rpt.Site = Me.Site
        Return rpt
    End Function
