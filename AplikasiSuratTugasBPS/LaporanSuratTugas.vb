...
Public Class LaporanSuratTugas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AplikasiSuratTugasBPS.LaporanSuratTugas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanSuratTugas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanSuratTugas = New LaporanSuratTugas()
        rpt.Site = Me.Site
        Return rpt
    End Function
