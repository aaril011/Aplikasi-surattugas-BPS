...
Public Class LpSuratTugas2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AplikasiSuratTugasBPS.LpSuratTugas2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLpSuratTugas2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LpSuratTugas2 = New LpSuratTugas2()
        rpt.Site = Me.Site
        Return rpt
    End Function
