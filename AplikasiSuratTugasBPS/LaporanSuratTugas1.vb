...
Public Class LaporanSuratTugas1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AplikasiSuratTugasBPS.LaporanSuratTugas1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanSuratTugas1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanSuratTugas1 = New LaporanSuratTugas1()
        rpt.Site = Me.Site
        Return rpt
    End Function
